...
export const TextMessageBoxFile = ({onSendMenssage, placeholder, disableCorrections= false, accept}: Props) => {


    const [message, setMessage] = useState("")
    const [selectedFile, setstatSelectedFile] = useState<File | null>(null)
  ...
  return (
    <form onSubmit={ handleSendMessage } 
        ...
        <div className="mr-2">
            ...
            <input type="file" ref={inputFileRef} accept={accept} hidden onChange={ (e) => setstatSelectedFile (e.target.files?.item(0) )}/>
        </div>
