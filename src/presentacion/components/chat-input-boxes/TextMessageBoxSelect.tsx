...
interface Props{
    onSendMenssage: (message: string, selectedOption: string) => void;
    placeholder?: string;
...
export const TextMessageBoxSelect = ({onSendMenssage, placeholder, disableCorrections= false, options}: Props) => {
    ...
    const handleSendMessage = (event: FormEvent<HTMLFormElement>) =>{
        ...
        onSendMenssage(message, selectedOption);
        setMessage('')
